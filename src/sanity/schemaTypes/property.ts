  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          name: 'lotWidth',
          title: 'Frente del terreno (m)',
          type: 'number',
          description: 'Medidas del lote. Si cargás frente y fondo, la ficha muestra "12 × 50 m". Dejalos vacíos si el terreno es irregular.',
          validation: (r) => r.positive(),
        }),
        defineField({
          name: 'lotDepth',
          title: 'Fondo del terreno (m)',
          type: 'number',
          validation: (r) => r.positive(),
        }),
