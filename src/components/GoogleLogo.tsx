/**
 * Logo de Google (svgl.app). Va inline y no como <Image>: el CSP declara
 * `img-src 'self' data: blob: https://cdn.sanity.io`, y a 18px un request
 * aparte para un ícono no se justifica.
 *
 * Los ids del SVG son globales en el documento, por eso están prefijados
 * `google__`. Si se agrega otro SVG inline al sitio, mantener esa convención
 * o los degradados se pisan entre sí sin dar error.
 */
