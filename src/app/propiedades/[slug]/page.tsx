...
import { ArrowLeft, Bed, Bath, Ruler, Car, Trees, MapPin, X, ChevronLeft, ChevronRight, Waves, Phone, Send } from '@/lib/icons';
...
export default function PropertyDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-background-alt relative">
      {/* Background decorators — clipped to prevent horizontal overflow */}
            ...
            >
              <AnimatePresence mode="wait" initial={false}>
                <motion.img
                  ...
                  style={currentImage === 0 ? { viewTransitionName: `prop-img-${property._id}`, borderRadius: '0.75rem' } : undefined}
              ...
              {property.images.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-3 top-1/2 -translate-y-1/2 p-2 bg-black/40 backdrop-blur-sm text-white rounded-full opacity-100 md:opacity-0 md:group-hover/gallery:opacity-100 hover:bg-black/65 transition-all duration-200 cursor-pointer z-10"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-2 bg-black/40 backdrop-blur-sm text-white rounded-full opacity-100 md:opacity-0 md:group-hover/gallery:opacity-100 hover:bg-black/65 transition-all duration-200 cursor-pointer z-10"
              ...
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-2">
                {property.images.length > 1 && property.images.map((_, idx) => (
                  <button
                    key={idx}
                    onClick={(e) => { e.stopPropagation(); setCurrentImage(idx); }}
                    className={`h-1.5 rounded-full transition-all duration-200 cursor-pointer ${
                      idx === currentImage ? 'bg-white w-5' : 'bg-white/50 w-1.5 hover:bg-white/80'
                    }`}
            ...
            <AnimateIn delay={100}>
              <div className="bg-white rounded-2xl border border-border p-6">
                ...
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  ...
                  <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-background-alt text-gray">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 py-6 border-y border-border">
                  {property.features.bedrooms && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-secondary text-sm">{property.features.bedrooms}</p>
                  ...
                  {property.features.bathrooms && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-secondary text-sm">{property.features.bathrooms}</p>
                  ...
                  {property.features.coveredArea && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-secondary text-sm">{property.features.coveredArea} m²</p>
                  ...
                  {property.features.totalArea && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-secondary text-sm">{property.features.totalArea} m²</p>
                  ...
                  {property.features.garage && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-secondary text-sm">Sí</p>
              ...
              <div className="bg-white rounded-2xl border border-border p-6">
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2.5 w-full py-3.5 border border-border text-secondary font-medium rounded-xl hover:bg-background-alt transition-colors text-sm"
                  >
                ...
                {formSubmitted ? (
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="group w-full flex items-center justify-center gap-2 py-2.5 bg-secondary text-white font-medium rounded-lg hover:bg-secondary/85 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 active:shadow-sm transition-all duration-200 text-sm cursor-pointer"
                    >
                      Enviar mensaje
            ...
            <div className="flex items-center justify-between gap-4 px-5 py-4 bg-secondary">
              <div className="flex items-center gap-3 min-w-0">
                <div
                  ...
                  style={{ background: 'rgba(1,143,51,0.3)', border: '1px solid rgba(1,143,51,0.4)' }}
                >
